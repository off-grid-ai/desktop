...
type MessageType = 'ping' | 'pong' | 'pair_request' | 'pair_challenge' | 'pair_response' | 'pair_confirm' | 'pair_reject' | 'text' | 'file_request' | 'file_accept' | 'file_reject' | 'file_chunk' | 'file_complete' | 'file_ack' | 'app' | 'error';
interface Message {
    type: MessageType;
    id: string;
    timestamp: number;
